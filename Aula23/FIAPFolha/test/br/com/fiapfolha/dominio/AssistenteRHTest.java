...
public class AssistenteRHTest {
	...
	@Test
	void igualdadeAssistentes(){
		AssistenteRH assistente = new AssistenteRH(100, "4444", LocalDate.of(1980, 10, 10), 0);
		AssistenteRH outroAssistente = new AssistenteRH(100, "4444", LocalDate.of(1980, 10, 10), 0);

		Assertions.assertEquals(assistente, outroAssistente);
	}
}
